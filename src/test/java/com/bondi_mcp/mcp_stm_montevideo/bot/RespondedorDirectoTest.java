...
class RespondedorDirectoTest {
    ...
    void el_saludo_y_los_comandos_de_ayuda_explican_como_usarlo() {
        assertThat(respondedor.responder(1L, "/start")).contains("3977", ">", "ubicación");
        assertThat(respondedor.responder(1L, "hola")).contains("3977");
    }
    ...
    void un_numero_de_parada_devuelve_los_arribos() {
        ...
        final String respuesta = respondedor.responder(1L, "3977");
    ...
    void un_numero_que_no_es_parada_pero_si_linea_devuelve_la_linea() {
        ...
        final String respuesta = respondedor.responder(1L, "185");
    ...
    void parada_y_linea_devuelven_las_proximas_salidas_teoricas() {
        ...
        final String respuesta = respondedor.responder(1L, "3977 185");
    ...
    void origen_mayor_destino_planifica_el_viaje() {
        ...
        final String respuesta = respondedor.responder(1L, "estadio centenario > pocitos");
    ...
    void avisame_crea_una_alerta_con_el_umbral_pedido() {
        given(guardiaDeArribos.crear(7L, 3977L, "185", 10)).willReturn("creada");

        assertThat(respondedor.responder(7L, "avisame 3977 185 10")).isEqualTo("creada");
    }

    @Test
    void avisame_sin_minutos_usa_el_umbral_por_defecto() {
        given(guardiaDeArribos.crear(7L, 3977L, "ce1", null)).willReturn("creada");

        assertThat(respondedor.responder(7L, "Avísame 3977 ce1")).isEqualTo("creada");
    }

    @Test
    void alertas_y_cancelar_van_a_la_guardia_del_chat_correcto() {
        given(guardiaDeArribos.listar(7L)).willReturn("tus alertas");
        given(guardiaDeArribos.cancelar(7L)).willReturn("cortadas");

        assertThat(respondedor.responder(7L, "alertas")).isEqualTo("tus alertas");
        assertThat(respondedor.responder(7L, "cancelar")).isEqualTo("cortadas");
    }
    ...
    void una_caida_de_la_intendencia_no_tira_excepcion_al_chat() {
        ...
        final String respuesta = respondedor.responder(1L, "18 de julio y ejido");
